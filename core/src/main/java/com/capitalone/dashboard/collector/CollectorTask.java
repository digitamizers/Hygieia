...
public abstract class CollectorTask<T extends Collector> implements Runnable {
    ...
    {
    	return collectorName.equals(FeatureCollectorConstants.JIRA) | collectorName.equals(FeatureCollectorConstants.GITHUB) | collectorName.equals(FeatureCollectorConstants.HUDSON);
    }
}
